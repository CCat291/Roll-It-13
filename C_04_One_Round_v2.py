...
# If the computer has fewer points, switch the computer to player 'player 1'
else:
...
while player_1_points < 13 and player_2_points < 13:
    print()
    print("Press <enter> to continue this round\n")

    # First person rolls the bie and score is updated
    player_1_roll = random.randint(1, 6)
    player_1_points += player_1_roll

    print(f"{first}: Rolled a {player_1_roll} - has {player_1_points} points")

    # If the first persons score is over 13, end round
